...
### 9. Install Cyberduck {#install-Cyberduck}

Cyberduck is a program that allows you to browse files on a remote server. Download [here](https://cyberduck.io/).

### 10. Install UCSB's Pulse Secure Campus VPN (Virtual Private Network) {#install-VPN}
...
### 11. Create your Slack account and join MEDS {#Slack}
...
### 12. Access Google apps through your @ucsb.edu account {#Google-apps}
...
### 13. Request key card access to Bren / NCEAS {#Access-IDs}
