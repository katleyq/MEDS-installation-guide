...
Visit [cloud.r-project.org](https://cloud.r-project.org/) to download the most recent version of R for your operating system. You should have *at least* version ~~4.3.1 (released 2023-06-16)~~ 4.4.0 (released 2024-04-24) running when you start MEDS.
...
- Open RStudio (click on the logo shown below): **If upon opening RStudio you are prompted to install Command Line Tools, do it.**
...
- If you get something that looks like a file path to git on your computer (e.g. `/usr/local/bin/git`, though it could differ slightly on your computer), then you have git installed. If you instead get no response at all, you should download & install git here: [git-scm.com/downloads](https://git-scm.com/downloads)
...
**END {{< fa brands apple >}} Mac Installation Guide**
:::